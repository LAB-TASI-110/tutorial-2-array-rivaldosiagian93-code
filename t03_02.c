...
int main() {
    ...
    // Variabel baru untuk rata-rata dua angka pertama
    ...
    for (int i = 0; i < n; i++) {
        ...
        // Langkah 6: Simpan Dua Angka Pertama dan Hitung Rata-rata
    ...
    if (count_valid_inputs > 0) {
        ...
        if (count_valid_inputs >= 2) { // Pastikan setidaknya ada 2 input untuk rata-rata
            printf("%.2f\n", avg_first_two);
        } else {
